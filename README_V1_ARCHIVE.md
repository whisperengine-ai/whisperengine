# 🎭 WhisperEngine v1 (Archived)

> ⚠️ **This documentation is archived.** WhisperEngine v1 is in maintenance mode. Please see **[WhisperEngine v2](https://github.com/whisperengine-ai/whisperengine-v2)** for active development.
